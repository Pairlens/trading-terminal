...
export const BUNDLED_POSTERS: Record<string, string> = {
  ...
  'coingecko-nft-provider': '/posters/coingecko-nft-provider.png',
  ...
  'deepseek-inference': '/posters/deepseek-inference.png',
  ...
  'opensea-nft-connector': '/posters/opensea-nft-connector.png',
