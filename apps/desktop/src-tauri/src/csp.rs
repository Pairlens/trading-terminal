...
const BASELINE_CONNECT_SRC: &str = "'self' blob: data: ipc: tauri://localhost http://ipc.localhost asset://localhost http://asset.localhost http://localhost:* ws://localhost:* https://pairlens.finance https://*.pairlens.finance https://*.okx.com wss://*.okx.com wss://*.okx.com:8443 https://*.binance.com wss://*.binance.com https://*.binance.us wss://*.binance.us wss://*.binance.us:9443 https://*.bnbstatic.com https://testnet.binance.vision wss://testnet.binance.vision https://*.bybit.com wss://*.bybit.com https://*.bybit.nl wss://*.bybit.nl https://*.bitvavo.com wss://*.bitvavo.com https://*.mexc.com wss://*.mexc.com https://*.kucoin.com wss://*.kucoin.com https://*.kucoin.eu wss://*.kucoin.eu https://openapi-sandbox.kucoin.com https://*.gateio.ws wss://*.gateio.ws https://*.gateapi.io wss://*.gate.com https://*.coinbase.com wss://*.coinbase.com https://*.bitget.com wss://*.bitget.com https://*.kraken.com wss://*.kraken.com https://*.huobi.pro wss://*.huobi.pro https://*.crypto.com wss://*.crypto.com https://*.3ona.co wss://*.3ona.co https://*.bitfinex.com wss://*.bitfinex.com https://*.upbit.com wss://*.upbit.com https://*.alpaca.markets wss://*.alpaca.markets https://*.kalshi.com https://*.kalshi.co https://*.polymarket.com wss://*.polymarket.com https://*.kyberswap.com https://jup.ag https://*.jup.ag https://*.dexpaprika.com https://*.geckoterminal.com https://*.publicnode.com https://*.solana.com https://api.groq.com https://api.openai.com https://api.anthropic.com https://api.telegram.org https://api.coingecko.com https://api.alternative.me https://*.posthog.com https://cdn.jsdelivr.net https://pypi.org https://files.pythonhosted.org";
