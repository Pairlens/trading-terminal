...
tab beside the tape and trait floors.
...
| NFT         | **Collector**, for picking a token rather than the floor: the items grid at full width with trait floors in their own column, and the ticket still there                                 |
