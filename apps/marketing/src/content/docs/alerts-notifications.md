...
description: Build alert flows from events, conditions, and delivery channels, including price crossings, order fills, candle closes, and webhooks.
group: traders
parent: automation
order: 2
eyebrow: For traders
...
event payload. This is the escape hatch: pipe alerts into Discord, Telegram,
your own service, or anything that accepts a hook.
...
it to confirm your webhook URL is right and your OS notifications are actually
permitted before you rely on them.
