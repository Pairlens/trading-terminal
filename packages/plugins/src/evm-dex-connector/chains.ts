...
export const EVM_CHAINS: Record<string, EvmChainConfig> = {
  ethereum: {
    ...
    kyberSlug: 'ethereum',
    geckoNetwork: 'eth',
    iconUrl: '/posters/ethereum-dex-connector.png',
  ...
  base: {
    ...
    kyberSlug: 'base',
    geckoNetwork: 'base',
    iconUrl: '/posters/base-dex-connector.png',
  ...
  arbitrum: {
    ...
    iconUrl: '/posters/arbitrum-dex-connector.png',
  ...
  bsc: {
    ...
    kyberSlug: 'bsc',
    geckoNetwork: 'bsc',
    iconUrl: '/posters/bsc-dex-connector.png',
  ...
  polygon: {
    ...
    iconUrl: '/posters/polygon-dex-connector.png',
